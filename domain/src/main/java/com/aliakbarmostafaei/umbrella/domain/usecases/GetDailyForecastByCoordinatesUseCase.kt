 ...
 */
class GetDailyForecastByCoordinatesUseCase(private val repository: WeatherRepository) {
    ...
    operator fun invoke(latitude: String, longitude: String, isImperial: Boolean) =
        repository.getDailyForecastByCoordinates(latitude, longitude, isImperial)
}